...
class EditKTPScreen extends React.Component {
  constructor(props) {
    super(props);
    this.globallang = getPageLang('global');

    this.state = {
      title: 'Edit KTP/Passport',
      canGoBack: true,
  ...
  doChangeKTP = () => {
    ...
    console.log(params);
    this.storeDataProfile('ktp', JSON.stringify(params));
    this.props.navigation.replace('Profile');
  };
        ...
        <View
          ...
          <View style={styles.headerTitle}>
            ...
            <View style={{flex: 0, flexDirection: 'column', paddingRight: 14}}>
              <TouchableOpacity onPress={() => this.doChangeKTP()}>
                <View style={{justifyContent: 'center', flexDirection: 'row'}}>
