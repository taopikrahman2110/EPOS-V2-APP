...
class NotifikasiScreenPage extends React.Component {
  constructor(props) {
    super(props);
  ...
  receivePost(param) {
    ...
    if (jsonParam.code === undefined) {
      ...
      if (jsonParam.code === "need-beranda") {
        this.props.navigation.replace("Home");
      } else if (jsonParam.code === "need-unread-notif") {
...
export default NotifikasiScreenPage;
